      ...
      <div className="space-y-20">
         ...
         <div className="grid md:grid-cols-2 gap-20">
            <div className="space-y-12">
               <div className="space-y-6">
                  <label className="text-[10px] font-black uppercase tracking-widest text-white">Active Assignment / Role</label>
                  <Input value={form.role} onChange={e => setForm({...form, role: e.target.value})} className="h-20 text-2xl font-serif italic text-white" placeholder="e.g. 1st Assistant Camera" />
               </div>
               <div className="space-y-6">
                  <label className="text-[10px] font-black uppercase tracking-widest text-white">Guild Alignment</label>
                  <Select value={form.unionTypeId || ''} onChange={e => setForm({...form, unionTypeId: e.target.value, isUnion: !!e.target.value})} className="h-20 text-xl font-serif italic text-white">
            ...
            <div className="space-y-12">
               <div className="grid grid-cols-2 gap-10">
                  ...
                  <div className="space-y-6">
                     <label className="text-[10px] font-black uppercase tracking-widest text-white">Total Scaling ($)</label>
                     ...
                     {['CONFIRMED', 'TENTATIVE'].map(s => (
                       <button 
                         ...
                         className={clsx(
                           ...
                           form.status === s ? "bg-accent text-black border-accent" : "glass-ui text-white hover:border-white/20"
                         )}
                       >
                         {s}
                       </button>
